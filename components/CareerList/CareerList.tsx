...
import { IconBriefcase, IconCircleCheck, IconMapPin, IconSchool } from '@tabler/icons-react';
import { Box, Button, Divider, Flex, Modal, Paper, Text, Title } from '@mantine/core';
import { useDisclosure } from '@mantine/hooks';
import { Career } from '@/utils/careerType';
...
const CareerList = () => {
  ...
  const [openCollapseIndex, setOpenCollapseIndex] = useState<number | null>(null); // Track which section is open
          ...
          <Box>
            <Flex wrap="wrap" justify="space-between" mb={20}>
              ...
              <Flex
                ...
                mx={{ base: 'auto', lg: 0 }}
              >
                <Text ta="right">{el.isPermanent ? 'Permanent' : 'Temporary'}</Text>
                <Button
                  my={10}
                  size="md"
                  w="fit-content"
                ...
                >
                  {openCollapseIndex === index ? 'Hide Details' : 'View Details'}
                </Button>
              </Flex>
            </Flex>
