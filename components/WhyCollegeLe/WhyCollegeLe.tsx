  ...
  return (
    <Box my={80}>
      ...
      <Text ta="center" mb={50}>
        Join CollegeLe to be part of a leading college search platform focused on finding colleges.
        Work with top professionals, utilise advanced technology, and make a significant impact on
      ...
      <SimpleGrid cols={{ base: 1, lg: 2 }}>
        {data.map((el, index) => (
          <Flex
            key={index}
            style={{ boxShadow: '0px 4px 24px 0px hsla(212,9%,59%,.2)', borderRadius: 20 }}
            p={10}
          >
            <Image src={el.image} h={80} />
            <Box m={5}>
